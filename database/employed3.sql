...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Okt 2024 pada 03.45
...
(32009, 'Alfayed074@gmail.com', 'alfayed123', 'Mohammad Dody Dwi Alfayed', 'Laki-Laki', '  samarind', '2000-02-18', ' Islam ', 'Pluto barat dikit', '081345938489', '1234567', 'HRD'),
(32010, 'alfayed074@gmail.com', 'alfayed123', 'Mohammad Dody Dwi Alfayed', 'Laki-Laki', '  samarind', '2000-12-25', ' Islam ', 'Pluto barat dikit', '081345938489', '1234567', 'HRD');
...
('LWG0001', 'Operator mesin dan Kendaraan', 'Samarinda', '2024-03-07', '2024-09-26', '<p><strong>Tanggung Jawab:</strong></p><ul><li>Mencapai target penjualan.</li><li>Mencari, mengidentifikasi calon pelanggan dan potensial pasar</li><li>Mempertahankan &nbsp;kepuasan pelanggan.</li></ul><p><strong>Persyaratan:</strong></p><ul><li>Usia maksimal 30 tahun (laki-laki/perempuan).</li><li>Memiliki gelar sarjana (S1).</li><li>Pengalaman dalam penjualan minimal 1 tahun.</li><li>Kepribadian yang sangat baik, komunikasi yang baik &amp; keterampilan interpersonal.</li><li>Agresif.</li></ul><p><strong>Manfaat :</strong></p><ul><li>Gaji pokok, intensif, tunjangan transportasi.</li></ul>', 'sastra Mesin', 'sungai siring', '118009', 'aktif'),
('LWG0002', 'Teknisi', 'Jakarta', '2017-10-14', '2017-12-06', '<p><strong>Kualifikasi :</strong></p><ul><li>Pria, umur max 30 tahun.</li><li>Pendidikan Minimal SMA/STM/D3.</li><li>Menyukai Pekerjaan Lapangan/Teknis.</li><li>Berpengalaman min 1 tahun.</li></ul><p><strong>Manfaat :</strong></p><ul><li>Gaji + insentif menarik.</li></ul>', 'Sipil/ teknik', 'Jabodetabek', '1234567', 'aktif'),
...
(320016, 'Operator mesin dan K', 'Samarinda', 'udinganteng123@gmail.com', 'udinudin123', 'Udin maha ganteng', '-- Pilih --', ' samarinda', '1992-12-16', 'jeddah\r\n', ' 7742', 'Las vegas ', '081345938489', '082345662456', '478623876423764', 'Indonesia', '-- Pilih Agama ', 'mancing', 'pluto', '23748', 'jeddah', '-- Pilih Status', '', 'megawati', '-- Pilih --', 'mars', '082345662456', 'S2', 'Stella Jeruk', 'Sastra Mesin', '2018-06-05', '2022-06-15', 5, '', '', '', '', '0000', '', '', '', '-- Pilih --', '-- Pilih --', '-- Pilih --', '-- Pilih --', '', '0000-00-00', '0000-00-00', '', '', '', '', '', '', '8.000.000', '551638561-screenshot-2024-06-24-193054.png', '46323974-bg4.jpeg', '471414044-kelompok-kapita-selekta-gasal.pdf');
...
--
ALTER TABLE `admin`
  MODIFY `id_admin` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32011;

--
-- AUTO_INCREMENT untuk tabel `pelamar`
--
ALTER TABLE `pelamar`
  MODIFY `id_pelamar` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=320017;
