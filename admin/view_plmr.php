                ...
                <div class="col-md-12">
                    <table id="example" class="table table-responsive table-hover" cellspacing="0" width="100%"  >
                        ...
                        <tbody>
                            ...
                            $query = "SELECT DISTINCT id_pelamar, posisi_pekerjaan, lokasi_seleksi, nama, pendidikan, nm_sekolah, jurusan FROM master_pelamar";
                            // Query untuk menampilkan semua data lowongan
